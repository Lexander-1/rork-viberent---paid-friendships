...
extension Crew {
    static let sampleCrews: [Crew] = [
        Crew(
            ...
            messages: [
                CrewMessage(id: "cm1", senderId: "1", senderName: "Sarah Chen", text: "Found an amazing new roaster in Brooklyn!", createdAt: Date().addingTimeInterval(-7200), type: .text, replyToId: nil, replyToText: nil, sharedPostId: nil, sharedPostAuthor: nil, sharedPostCaption: nil, bookingInfo: nil, voiceNoteDuration: nil, imageURL: nil, fileName: nil, fileSize: nil),
                CrewMessage(id: "cm2", senderId: "5", senderName: "Emma Wilson", text: "Omg where?? I need to try it", createdAt: Date().addingTimeInterval(-3600), type: .text, replyToId: nil, replyToText: nil, sharedPostId: nil, sharedPostAuthor: nil, sharedPostCaption: nil, bookingInfo: nil, voiceNoteDuration: nil, imageURL: nil, fileName: nil, fileSize: nil),
                CrewMessage(id: "cm3", senderId: "current", senderName: "Alex Morgan", text: "Let's all go this weekend!", createdAt: Date().addingTimeInterval(-1800), type: .text, replyToId: nil, replyToText: nil, sharedPostId: nil, sharedPostAuthor: nil, sharedPostCaption: nil, bookingInfo: nil, voiceNoteDuration: nil, imageURL: nil, fileName: nil, fileSize: nil)
            ],
        ...
        Crew(
            ...
            messages: [
                CrewMessage(id: "cm4", senderId: "7", senderName: "Aisha Thompson", text: "Morning run tomorrow at 6am?", createdAt: Date().addingTimeInterval(-14400), type: .text, replyToId: nil, replyToText: nil, sharedPostId: nil, sharedPostAuthor: nil, sharedPostCaption: nil, bookingInfo: nil, voiceNoteDuration: nil, imageURL: nil, fileName: nil, fileSize: nil),
                CrewMessage(id: "cm5", senderId: "3", senderName: "Priya Patel", text: "I'm in! Meeting at the park entrance?", createdAt: Date().addingTimeInterval(-10800), type: .text, replyToId: nil, replyToText: nil, sharedPostId: nil, sharedPostAuthor: nil, sharedPostCaption: nil, bookingInfo: nil, voiceNoteDuration: nil, imageURL: nil, fileName: nil, fileSize: nil)
            ],
